  ...
  <section id="header">
    <div class="header container">
      <div class="nav-bar">
        <div class="brand">
          <a href="#hero">
            <h1><span>N</span>ATA_<span>V</span>ERSION</h1>
          </a>
        </div>
        <div class="nav-list">
          <div class="hamburger">
          ...
          <ul>
            ...
            <li><a href="./registration/index.php" id="sign_up" data-after="#Sign_up">Sign Up</a></li>
            <li><a href="./login/index.php" data-after="Login"><i style="font-size:3rem" class="fa fa-user"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section id="hero">
    <div class="hero container">
      <div>
        ...
        <h1>We are NATA_VERSION <span></span></h1>
